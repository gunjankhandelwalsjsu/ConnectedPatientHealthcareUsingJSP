...
<div class="login">
    ...
    <c:if test="${requestScope.person eq null}">
        <form action='<c:out value="${loginURL}"></c:out>' method="post">
            <ul>
              <li>
                 <span class="un"><i class="fa fa-user"></i></span><input type="text" name="firstName" required class="text" placeholder="Email"/></li>
              <li>
                 <span class="un"><i class="fa fa-lock"></i></span><input type="password" name="lastName" required class="text" placeholder="User Password"/></li>
              <li>
			...
			<tbody>
				...
				<c:forEach items="${requestScope.persons}" var="person">
					...
					<tr>
						...
						<td><c:out value="${person.streetAddress}"></c:out></td>

...
<p>Hello Patient, <c:out value="${person.firstName}"/>!</p>
 
	<c:if test="${doctor ne null}">
      
 ID: <input type="text" value="${doctor.id}"
                readonly="readonly" name="id"><br> 
<center><h3>	First Name: <input type="text" value="${doctor.firstName}" name="firstName"><br></h3></center>
<center><h3>	Last Name: <input type="text" value="${doctor.lastName}"   name="lastName"><br></h3></center>
<center><h3>	Email: <input type="text" value="${doctor.email}" name="email"><br></h3></center>
<center><h3>	Phone: <input type="text" value="${doctor.phone}"   name="phone"><br></h3></center>
<center><h3>	Street Address: <input type="text" value="${doctor.streetAddress}" name="streetAddress"><br></h3></center>
<center><h3>	City: <input type="text" value="${doctor.city}"   name="city"><br></h3></center>
<center><h3>	Zip code: <input type="text" value="${doctor.zipCode}"   name="zipCode"><br></h3></center>
	<c:url value="/addDoctorToPatientProfile" var="addDoctorToPatientProfileURL">
                   <c:param name="id" value="${doctor.id}"></c:param>
                  </c:url>	  	   
		    <form action='<c:out value="${addDoctorToPatientProfileURL}"></c:out>' method="post">
			
<center><h3>	<input type="submit"	value="Add doctor"></h3></center>
</form>               
	</c:if>    

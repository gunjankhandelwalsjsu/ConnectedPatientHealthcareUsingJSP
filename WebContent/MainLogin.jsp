...
<body>
<div class="form">
<div class="header"><h2>Select your Registration type</h2></div>
<div class="login">
<form action="">
<ul>
<li>
<div class="up a"><a href="loginDoctor.jsp">Doctor Login</a></div>
<li>
<div class="up"><a href="login.jsp">Patient Login</a></div>
</li>
</ul>
</form>

...
@import
	url("http://fonts.googleapis.com/css?family=Source+Sans+Pro:400,700");
				...
				<form action='<c:out value="${addURL}"></c:out>' method="post">
					<ul>
						...
						<li><span class="un"><i class="fa fa-user"></i></span><input
							type="text" name="firstName" required class="text"
							placeholder="First Name" /></li>

						<li><span class="un"><i class="fa fa-user"></i></span><input
							type="text" name="lastName" required class="text"
							placeholder="Last Name" /></li>

						<li><span class="un"><i class="fa fa-user"></i></span><input
							type="text" name="email" required class="text"
							placeholder="Email" /></li>
						<li><span class="un"><i class="fa fa-lock"></i></span><input
							type="password" name="password" required class="text"
							placeholder="User Password" /></li>
						<li><span class="un"><i class="fa fa-lock"></i></span><input
							type="text" name="phone" required class="text"
						...
						<li><span class="un"><i class="fa fa-user"></i></span><input
							type="date" name="birthDate" required class="text"
							placeholder="Birth Date" /></li>


						<li><span class="un"><i class="fa fa-user"></i></span><input
							type="text" name="streetAddress" required class="text"
							placeholder="Street Address" /></li>

						<li><span class="un"><i class="fa fa-user"></i></span><input
							type="text" name="state" required class="text"
							placeholder="State" /></li>

						<li><span class="un"><i class="fa fa-user"></i></span><input
							type="text" name="city" required class="text" placeholder="City" /></li>

						<li><span class="un"><i class="fa fa-user"></i></span><input
							type="text" name="zipcode" required class="text"
							placeholder="Zip Code" /></li>

						<label>FoodAllergies:</label>
						<br />

						<input type="checkbox" name="Allergy" value="soybean" />
						<span>soybean</span>
						<br />
						...
						<span>egg</span>
						<br />
						<input type="checkbox" name="Allergy" value="mustard" />
						<span>mustard</span>
						<br />
						...
						<span>fish</span>
						<br />
						<input type="checkbox" name="Allergy" value="coconut" />
						<span>coconut</span>
						<br />
						<input type="checkbox" name="Allergy" value="seasme seeds" />
						<span>seasmeSeeds</span>
						<br />
						<input type="checkbox" name="Allergy" value="corn" />
						<span>corn</span>
						<br />
						<input type="checkbox" name="Allergy" value="Flour" />
						<span>flour</span>
						<br />
						<input type="checkbox" name="Allergy" value="Whey-powder" />
						<span>wheyPowder</span>
						<br />
						<input type="checkbox" name="Allergy" value="Cornstarch" />
						<span>cornstarch</span>
						<br />
						<input type="checkbox" name="Allergy" value="Celery" />
						<span>celery</span>
						<br />
						<input type="checkbox" name="Allergy" value="Candlenut" />
						<span>candlenut</span>
						<br />
						<label>Disease and history:</label>
						<br />
						<input type="checkbox" name="Disease" value="diabetics" />
						<span>Diabetics</span>
						<br />
						<input type="checkbox" name="Disease" value="bloodpressure" />
						<span>Blood Pressure</span>

						<li><input type="submit" value="Sign up" class="btn">
						</li>
					</ul>
